...
class Agent(BaseAgent):
    ...
    def send_exception(self, exception):
        ...
        if isinstance(exception, SystemExit):
            msg = {'RS': {'errcode': 0, 'errmsg': str(exception)}}
        else:
            msg = {'RS': {'errcode': 1, 'errmsg': str(exception)}}
    ...
    def run(self):
        ...
        while True:
            ...
            if msg_type == 'PLAYERACTION':
                ...
                self.send_exception(Exception(f'Unknown message type: {msg_type}.'))
